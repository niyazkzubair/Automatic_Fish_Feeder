//#include <macros.h>
//#include <iom8v.h>
//enhancement done on 21/08/2007
//when ATMEGA32 was used, menus were poping up very fast, and so couldn't control during input. Need to add some 
//delay routine.
...
int main (void)
{
	...
	program_rtc = 1; //1 - to program RTC, 0-skip RTC programming
	if(program_rtc == 1)
	{
		//1
